...
public class EmpleadoDAO {
    ...
    public ArrayList<Empleado> getLista(ResultSet result) throws SQLException {
    ...
    public ArrayList<Empleado> buscarPorPatron (String nombre) throws SQLException {
        ...
        return getLista(result);
    }

    public ArrayList<Empleado> getListadoEmpleados() throws SQLException {
    ...
    private int insertarDatos(String nombre, int edad) throws SQLException {
    ...
    public int crear (Empleado empleado) throws SQLException {
        return insertarDatos(empleado.getNombre(), empleado.getEdad());
    }
