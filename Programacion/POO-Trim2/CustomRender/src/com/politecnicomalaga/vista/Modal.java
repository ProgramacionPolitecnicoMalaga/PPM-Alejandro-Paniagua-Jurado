...
public class Modal extends JDialog {
    ...
    private void añadirTemas() {
        ...
        comboBoxTema.addItem(ControladorItems.getTema(ControladorItems.IT));
        comboBoxTema.addItem(ControladorItems.getTema(ControladorItems.DESARROLLO));
        comboBoxTema.addItem(ControladorItems.getTema(ControladorItems.MANTENIMIENTO));
        comboBoxTema.addItem(ControladorItems.getTema(ControladorItems.GENERAL));
    }
}
